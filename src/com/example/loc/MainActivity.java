...
public class MainActivity extends FragmentActivity implements
    ...
    public void getLocation(View v) {
        ...
        if (servicesConnected()) {
        	//Log.d("Raj_Tag", "Play service available");
            // Get the current location
            Location currentLocation = mLocationClient.getLastLocation();

//            Toast.makeText(this, currentLocation.getLatitude()+"is lattitude and lang"+currentLocation.getLongitude(), Toast.LENGTH_LONG).show();
          //  Log.d("Raj_Tag", currentLocation.getLatitude()+"is lattitude and lang"+currentLocation.getLongitude());
            // Display the current location in the UI
            mLatLng.setText(LocationUtils.getLatLng(this, currentLocation));
           // Log.d("Raj_Tag", "from service"+LocationUtils.getLatLng(this, currentLocation));
        }
        else
        	{
        		//Log.d("Raj_Tag", "Play service not available");
        		Toast.makeText(this, "Play service not available", Toast.LENGTH_LONG).show();
        	}
    }
...
//            Geocoder geocoder = new Geocoder(localContext, Locale.getDefault());
            ...
            try {
               ...
               /* addresses = geocoder.getFromLocation(location.getLatitude(),
                ...
                addresses = MainActivity.getFromLocation(location.getLatitude(),
                        location.getLongitude(), 1
                    );
...
public static List<Address> getFromLocation(double lat, double lng, int maxResult){
		...
		try {
			...
			Log.e(LocationUtils.APPTAG, "Error calling Google geocode webservice.", e);
		} catch (IOException e) {
			Log.e(LocationUtils.APPTAG, "Error calling Google geocode webservice.", e);
		} catch (JSONException e) {
			Log.e(LocationUtils.APPTAG, "Error parsing Google geocode webservice response.", e);
		}
